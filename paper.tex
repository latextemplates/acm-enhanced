...
Finally, a conclusion is drawn and outlook on future work is made (\zcref{sec:outlook}).
...
\begin{ltgexample}
\zcref[S]{fig:label} shows something interesting.
...
\begin{ltgexample}
\zcref[S]{lst:XML} shows source code written in XML.
\zcref[S]{line:comment} contains a comment.
...
\zcref[S]{lst:flXML} shows the floating listing.
